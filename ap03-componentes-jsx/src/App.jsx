...
//3. Ajustar o componente App para que ele exiba "Me chamo Isabel e tenho 20 anos."
...
const App = () => {
  ...
  return (
    <div style={{margin: 'auto', width: 768, backgroundColor: '#EEE', padding: 12, borderRadius: 8}}>
      ...
      <input type="text" id="nome" style={{marginTop: 12, paddingTop: 8, paddingTop: 8, borderStyle: 'hidden', width: '100%', borderRadius: 8, outline: 'none'}}/>
